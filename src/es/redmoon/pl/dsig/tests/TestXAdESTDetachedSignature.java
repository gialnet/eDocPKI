...
public class TestXAdESTDetachedSignature {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BLOB signature = XAdES.createDetachedBES_T(keystore, keyStoreType, keyStorePassword, privateKeyPassword, document, name, description, mime, tsaUrl, tsaUser, tsaPassword);
			
			//XML.saveDocumentToFile(XML.getDocumentFromBLOB(signature), "./xadesDetached-T.xsig");
			XML.saveDocumentToFile(XML.getDocumentFromBLOB(signature), "./xadesDetached-T_Authenticated.xsig");
