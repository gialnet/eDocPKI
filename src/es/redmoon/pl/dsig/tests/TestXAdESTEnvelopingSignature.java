...
public class TestXAdESTEnvelopingSignature {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BLOB signature = XAdES.createEnvelopingBES_T(keystore, keyStoreType, keyStorePassword, privateKeyPassword, document, name, description, mime, tsaUrl, tsaUser, tsaPassword);
			
			//XML.saveDocumentToFile(XML.getDocumentFromBLOB(signature), "./xadesEnveloping-T.xsig");
			XML.saveDocumentToFile(XML.getDocumentFromBLOB(signature), "./xadesEnveloping-T_Authenticated.xsig");
