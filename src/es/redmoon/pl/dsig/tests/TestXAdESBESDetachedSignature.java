...
public class TestXAdESBESDetachedSignature {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BLOB signature = XAdES.createDetachedBES(keystore, keyStoreType, keyStorePassword, privateKeyPassword, document, name, description, mime);
			
			XML.saveDocumentToFile(XML.getDocumentFromBLOB(signature), "./xadesDetached.xsig");
