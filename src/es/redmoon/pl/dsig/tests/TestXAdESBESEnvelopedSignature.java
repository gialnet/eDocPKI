...
public class TestXAdESBESEnvelopedSignature {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BLOB signature = XAdES.createEnvelopedBES(keystore, keyStoreType, keyStorePassword, privateKeyPassword, document, name, description, mime);
			
			XML.saveDocumentToFile(XML.getDocumentFromBLOB(signature), "./xadesEnveloped.xsig");
